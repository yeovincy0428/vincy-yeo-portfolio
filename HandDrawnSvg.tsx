    ...
    case 'condo':
      ...
      return (
        <svg viewBox="0 0 320 180" fill="none" className="w-full h-full bg-[#FAF8F3]">
          ...
          <line x1="75" y1="65" x2="165" y2="50" stroke="#3A3632" strokeWidth="1.2" />
          <line x1="75" y1="85" x2="165" y2="70" stroke="#3A3632" strokeWidth="1.2" />
    ...
    case 'im-on-my-way':
      ...
      return (
        <svg viewBox="0 0 320 180" fill="none" className="w-full h-full bg-[#201D24]">
          ...
          <circle cx="230" cy="85" r="24" stroke="#FFB703" strokeWidth="2" fill="#382C1E" />
